    ...
    def update_count(self, matches, output_image = None):
        ...
        for vehicle in self.vehicles:
            if not vehicle.counted and (vehicle.frames_seen > 6):
                ...
                if (vehicle.last_position[0] >= 70 and vehicle.last_position[0] < frame_w):
...
# Video source
inputFile = loc+'/inputs/1700/UI_Conv_P2_06.avi'

# Background source
backgroundFile = loc+'/backgrounds/bg.jpg'
...
while ret:    
    ...
    if ret and frame_no < total_frames:
     ...
     # Compute the grayscale difference between the current grayscale frame and
        ...
        current_count = car_counter.vehicle_count
